...
from .views.dependente_views import (
    DependenteCreatView, DependenteListView
)
from .views.atendente_views import (
    AtendenteCreatView, AtendenteListView
)
...
urlpatterns = [
    ...
    path("form_dependente", DependenteCreatView.as_view(), name="cadastrar_dependente"),
    path("lista_dependentes", DependenteListView.as_view(), name="lista_dependentes"),
    path("form_atendente", AtendenteCreatView.as_view(), name="cadastrar_atendente"),
